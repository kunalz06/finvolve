...
const copyByStatus = {
  success: {
    ...
    copy: "You will no longer receive Finvolve newsletter emails. You can subscribe again anytime from the footer.",
  },
  invalid: {
    ...
    <div className="min-h-screen px-6 py-12">
      <div className="container max-w-2xl">
        <Card hover={false} className="glass-surface-strong p-8 text-center md:p-12">
          ...
          <Button href="/finvolve" variant="primary" className="mt-8">
            Back to Finvolve
          </Button>
        </Card>
      </div>
