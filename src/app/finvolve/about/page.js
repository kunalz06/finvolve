      ...
      <div className="container space-y-10">
          ...
          <div className="glass-surface-strong grid items-center gap-12 rounded-[36px] px-8 py-10 lg:grid-cols-2 lg:px-12">
            <motion.div initial={false} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="mb-8 max-w-xl text-lg leading-relaxed text-slate-600">
                Finvolve is a modern engineering agency obsessed with speed, precision, and reliability. We help businesses ship high-quality products quickly without sacrificing craft.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button href="/finvolve/contact" variant="primary" size="large">Get in Touch</Button>
                <Button href="/finvolve/services" variant="secondary" size="large">View Services</Button>
              </div>
            </motion.div>
        ...
        <section className="grid items-center gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-lg leading-relaxed text-slate-600">
              At Finvolve, our mission is to fuel businesses with high-performance technology. We do not just follow best practices, we push for sharper execution and better product clarity.
            </p>
        ...
        <section className="glass-surface-strong rounded-[36px] px-8 py-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button href="/finvolve/contact" variant="secondary" size="large">Contact Us</Button>
          </div>
        </section>
      </div>
    </div>
