...
Do not set DEV app server secrets on Netlify, including `RAZORPAY_KEY_SECRET`, Firebase Admin private keys, or SMTP passwords. The IEM Minor Netlify Function uses only the separate `IEM_RAZORPAY_*` keys.
